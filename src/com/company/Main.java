...
public class Main {
	...
	// write your code here
        ...
        // Create products
        Products ic1 = new Products("chocolate", "a flavor", 2.25);
        Products ic2 = new Products("cookies and cream", "a flavor", 2.25);
        Products ic3 = new Products("butter pecan", "a flavor", 2.25);
        Products ic4 = new Products("mint chocolate chip", "a flavor", 2.25);
        Products ic5 = new Products("pineapple", "a flavor", 2.25);
        ...
        Products pop1 = new Products("Sprit", "a flavor", 2.25);
        Products pop2 = new Products("Coke", "a flavor", 2.25);
        Products pop3 = new Products("Pepsi", "a flavor", 2.25);
        ...
        Products candy3 = new Products("Snickers", "a flavor", 2.25);
        Products candy4 = new Products("KitKat", "a flavor", 2.25);
        Products candy5 = new Products("Reeses", "a flavor", 2.25);
